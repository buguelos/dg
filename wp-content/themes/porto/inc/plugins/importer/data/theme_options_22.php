{
    ...
    "mainmenu-toplevel-hbg-color": "#2aafea",
    ...
    "mainmenu-popup-border-color": "#2aafea",
    ...
    "minicart-icon-color": "#2aafea",
    "minicart-item-color": "#2aafea",
    "minicart-border-color": "transparent",
    "minicart-bg-color": "transparent",
    "minicart-popup-border-color": "#2aafea",
    ...
    "post-related-btn-color":"btn-primary",
